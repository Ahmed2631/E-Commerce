...
namespace ECommerce.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            ///     directly from your code. This API may change or be removed in future releases.
            /// </summary>
            [Required(ErrorMessage = "Enter yourPassword")]
            ...
            [MaxLength(30, ErrorMessage = "Max Length is 30Char")]
            public string UserName { get; set; }
            [MaxLength(60,ErrorMessage ="Max Length is 60 Char")]
            public string? Adress { get; set; }
            [MaxLength(40, ErrorMessage = "Max Length is 40 Char")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        if(user.Email == "Ahmed254010@ECommerce.com")
                            await _userManager.AddToRoleAsync(user, TbRoles.Admin);
                        else
                            await _userManager.AddToRoleAsync(user, TbRoles.Customer);  //  <--
                    }
                    else
                    {
